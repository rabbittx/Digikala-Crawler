...
def make_seller_details(seller_detail,product_details):
     return {
            'seller_name':seller_detail['seller_name'],
            'seller_Membership_period':seller_detail['seller_Membership_period'],
            'seller_Satisfaction_with_the_goods':seller_detail['seller_Satisfaction_with_the_goods'],
            'Seller_performance':seller_detail['Seller_performance'],
            'People_have_given_points':seller_detail['People_have_given_points'],
            'timely_supply':seller_detail['timely_supply'],
            'Obligation_to_send':seller_detail['Obligation_to_send'],
            'No_return':seller_detail['No_return'],
