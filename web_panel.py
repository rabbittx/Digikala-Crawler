...
if __name__ == "__main__":
    ...
    WebScraperWebPanel(driver_path=config_manager.get_gecko_path(), db_path=config_manager.get_db_path(),driver_type=config_manager.get_driver_type(),HeadlessMode=config_manager.get_headless_mode(), log=log).start()
